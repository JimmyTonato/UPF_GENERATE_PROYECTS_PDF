...
def generate_tables_html(dates, datesHTML):
    ...
    idFileProtect2021 = "234328224/"
    #Once created the folders in the page they have an id to be able to enter and we put them here 
    idFilesWeb ={'Computational genomics':'234599466/' ,
                 'Computational systems biology': '234599492/',
                 'Pharmacoinformatics & systems pharmacology':'234599690/',
                 'Structural bioinformatics': "234599500/",
                  'Web development & bioinformatic tools': "234599604/"}
